...
def run_query(query: str,
  ...
  return html_tmpl.Card(word=query,
                        links=links,
...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument('word_list',
                      type=str,
                      help='file with words separated by line')
  parser.add_argument('--num_example_sentences',
                      default=1,
                      type=int,
  ...
  parser.add_argument('--num_pronunciations',
                      default=1,
                      type=int,
...
def main(args: argparse.Namespace) -> None:
  ...
  cards = cards_for_queries(words, args.directory, args.num_example_sentences,
